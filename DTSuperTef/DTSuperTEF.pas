...
type
  ...
  private
    ...
    // M�todos de convers�o JSON para objetos tipados
  ...
  public
    ...
    // === M�todos de compatibilidade (retornam JSON como antes) ===
...
// === M�todos auxiliares para convers�o JSON ===
...
// === M�TODOS PRINCIPAIS COM RETORNO TIPADO ===
...
begin
  ...
  try
    ...
    // Remove o �ltimo '&' se existir
    if URL.EndsWith('&') then
      Delete(URL, Length(URL), 1);

    // Prepara e executa requisi��o GET
...
// === M�TODOS DE COMPATIBILIDADE (mant�m os retornos JSON originais) ===
